...
class StepsBottom extends StatefulWidget {
  ...
  @override
  StepsBottomState createState() => StepsBottomState();
}

class StepsBottomState extends State<StepsBottom> {
  int activeStep = 0;
  int totalSteps = 3;
    ...
    return ElevatedButton(
      onPressed: () {
        if (activeStep < totalSteps - 1) {
          ...
          if (activeStep == 2) {
            widget.onStep3Complete(); // Mostrar "RecargasPage" en el BottomSheet
          }
        }
      },
