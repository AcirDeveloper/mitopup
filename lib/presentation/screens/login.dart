...
import 'package:mitopup/presentation/users/recover_password.dart';
        ...
        if (responseData == 'OK') {
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text('Error'),
                content: Text('El PIN no es correcto.'),
                actions: <Widget>[
                  TextButton(
                    child: Text('Aceptar'),
                    onPressed: () {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            KeypadRow(numbers: [1, 2, 3], onPressed: addPinNumber),
                            KeypadRow(numbers: [4, 5, 6], onPressed: addPinNumber),
                            KeypadRow(numbers: [7, 8, 9], onPressed: addPinNumber),
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  icon: Icon(Icons.arrow_back, size: 30.0, color: HexColor("#005CEE")),
                                  onPressed: () {
                                    print('Pin numbers before removing: $pinNumbers');
                                    removeLastPinNumber();
                                    print('Pin numbers after removing: $pinNumbers');
                                  },
                                ),
          ...
          if (_isLoading)
            Positioned.fill(
              child: Container(
                ...
                child: Center(
                  child: Loader(), // Usamos el Loader que creamos en "theme.dart"
                ),
              ),
            ),
        ],
