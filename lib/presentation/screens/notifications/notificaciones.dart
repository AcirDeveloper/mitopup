      ...
      body: Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            bool showSeparator =
                previousMonthYear != getMonthTitle(notificacion.date);
                ...
                if (showSeparator)
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        capitalize(getMonthTitle(notificacion.date)),
                        style: TextStyle(
