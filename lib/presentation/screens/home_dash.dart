...
class HomeDash extends StatefulWidget {
  ...
  HomeDash({required this.changePage});
  @override
...
class _HomeDashState extends State<HomeDash> {
      ...
      if (response.statusCode == 200) {
        ...
        for (var item in data) {
          ...
          try {
            ...
            final defaultColor = '#B0E0E6';
            color = defaultColor;
          }
          contactos.add(Contacto(
            idContacto: int.tryParse(idContacto) ?? 0,
  ...
  Future<void> _fetchPromos(String userId) async {
    final url =
        Uri.parse('http://5.161.187.55:8080/app.getPromos?idUser=$userId');
    try {
      final response = await http.get(url);

      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        List<CardData> promosData = [];
  ...
  Widget _buildCardWidget(CardData cardData) {
                  ...
                  children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment
                                  .start, // Alinea el botón "Agregar" en el inicio
                              children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            Literals.of(context).recargasRecientes,
                            style: const TextStyle(
                              fontFamily: 'Lato',
                              fontSize: 18,
                              fontWeight: FontWeight.w700,
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                crossAxisAlignment: CrossAxisAlignment
                                    .center, // Centra verticalmente los elementos en esta Row
                                children: [
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment
                                        .center, // Centra verticalmente los elementos en esta Column
                                    children: [
                                      Center(
  ...
  Widget _buildContactoWidget(Contacto contacto) {
    return Container(
      width: MediaQuery.of(context).size.width *
          0.2, // Ancho del 20% de la pantalla
      child: Column(
