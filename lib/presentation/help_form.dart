...
class AyudaForm extends StatefulWidget {
  ...
  @override
  AyudaFormState createState() => AyudaFormState();
}

class AyudaFormState extends State<AyudaForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: lightAppBarAyuda(
        title: Literals.of(context).formAyuda,
        leadingOnPressed: () {
          Navigator.push(
            context,
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                  Literals.of(context).formNombre,
                    style: const TextStyle(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: Literals.of(context).formNombrePlaceholder,
                      enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              width: 1,color: HexColor("#D2D5DA")
                          )
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            width: 2, color: HexColor("#0743DF")),
                      ),
                    ),
                    validator: (value) {
                      if (value!.isEmpty) {
                        return Literals.of(context).formNombreError;
                      }
                      return null;
                    },
                  ),
              ...
              Column(
                ...
                children: [
                  Text(
                  Literals.of(context).formMensaje,
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  ...
                  TextFormField(
                    ...
                    maxLines: 5,
                    decoration: InputDecoration(
                      hintText: Literals.of(context).formMensajePlaceholder,
                      enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                          width: 1,color: HexColor("#D2D5DA")
                        )
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return Literals.of(context).formMensajeError;
                      }
                      return null;
                    },
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    Literals.of(context).formAdjuntar,
                    style: TextStyle(
                      fontFamily: 'Lato',
                      fontSize: 16,
            ...
            SizedBox(
              ...
              child: _isButtonDisabled
                ...
                child: InkWell(
                  ...
                  child: Center(
                    child: Text(
                      Literals.of(context).formEnviar,
                      style: const TextStyle(
                        fontFamily: 'Lato',
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                ...
                style: ElevatedButton.styleFrom(
                  foregroundColor: Colors.white, backgroundColor: HexColor("#005CEE"),
                  padding: const EdgeInsets.all(16),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12),
                    side: BorderSide(
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final request =
        http.MultipartRequest('POST', Uri.parse('http://5.161.187.55:8080/app.guardaFormContacto'));
        ...
        if (_archivoPath != null && _archivoPath!.isNotEmpty) {
          final file = await http.MultipartFile.fromPath('archivo', _archivoPath!,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.pop(context); // Cerrar el BottomSheet al presionar "Aceptar"
                },
