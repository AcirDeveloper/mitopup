...
import 'package:mitopup/presentation/help_form.dart';
...
class CentroAyudaPage extends StatefulWidget {
  ...
  @override
  CentroAyudaPageState createState() => CentroAyudaPageState();
}

class CentroAyudaPageState extends State<CentroAyudaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: lightAppBarAyuda(
        title: Literals.of(context).ayudaTitle,
        leadingOnPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
      ...
      bottomNavigationBar: IntrinsicHeight(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(Literals.of(context).masAyuda),
