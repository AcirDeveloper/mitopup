...
class _RegistroState extends State<Registro> {
  ...
  Future<void> fetchSelectedCountry(int countryId) async {
    try {
      final response = await http
          .get(Uri.parse('http://5.161.187.55:8080/app.getPais?idPais=$countryId'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body) as List<dynamic>;
        if (data.isNotEmpty) {
  ...
  void _checkPhoneNumberField() {
    final phoneNumber = phoneNumberController.text.replaceAll(RegExp(r'[^0-9]'), '');
    final previousSelection = phoneNumberController.selection;
    setState(() {
      final requiredDigits = selectedCountry?.digitos ?? 0;
                  ...
                  Center(
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          Text(Literals.of(context).flow4_1,
                            style: TextStyle(
                              fontSize: 16.0,
                              ...
                              Expanded(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    elevation: 0,
                                    minimumSize: const Size(double.infinity, 60.0), // Aumenta la altura del botón
                                  ),
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Icon(
                                        ...
                                        color: HexColor("#34405F"), // Cambia el color del icono
                                      ),
                                    ],
                                  ),
                                ),
                              ...
                              Expanded(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: Literals.of(context).loginPlaceholder,
                          ...
                          SizedBox(
                            ...
                            child: DynamicButton(
                              ...
                              buttonText: capitalize(Literals.of(context).btnTopUpC),
                            ),
                          ),
                          const SizedBox(height: 10.0),
                          Row(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(fontSize: 24, color: HexColor("#DBDBDB")),
                                    ),
                                  ),
                                ),
                              ),
